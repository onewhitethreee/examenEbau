...
function BlogListPageContent(props: Props) {
  ...
  let description = `ENCONTRAR FACILMENTE LOS EXAMENTES DE EBAU`
            ...
            <div className={'col col--12'}>
              {!isPaginated && (
                <h1 className='blog__section_title' id='homepage_blogs'>
                  <Translate description='latest blogs heading'>{!metadata.permalink.includes('essay') ? 'Nuevo' : 'notebook'}</Translate>
                  &nbsp;
